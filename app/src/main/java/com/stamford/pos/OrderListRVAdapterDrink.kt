...
class OrderListRVAdapterDrink(private val orderlistdr: ArrayList<Drink>) : RecyclerView.Adapter<OrderListRVAdapterDrink.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: OrderListRVAdapterDrink.ViewHolder, position: Int) {
        val item= orderlistdr[position]
