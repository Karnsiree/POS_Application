...
class OrderListRVAdapterDessert(private val orderlistde: ArrayList<Dessert>) : RecyclerView.Adapter<OrderListRVAdapterDessert.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: OrderListRVAdapterDessert.ViewHolder, position: Int) {
        val item= orderlistde[position]
