...
class PlayMusicInBGService: Service() {
    // Just boolean variable to let us know if the music is being played.
    // true: playing, false: not playing
    private var playStatus = false
    // MediaPlayer instance
    private var mPlayer: MediaPlayer? = null

    // Looper is a worker that keeps a thread alive, loops through
    // MessageQueue and sends messages to the corresponding
    // handler to process.
