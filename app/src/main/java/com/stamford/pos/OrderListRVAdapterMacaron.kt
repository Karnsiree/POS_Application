...
class OrderListRVAdapterMacaron(
    private val orderlistma: ArrayList<Macaron>) : RecyclerView.Adapter<OrderListRVAdapterMacaron.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: OrderListRVAdapterMacaron.ViewHolder, position: Int) {
        val item= orderlistma[position]
